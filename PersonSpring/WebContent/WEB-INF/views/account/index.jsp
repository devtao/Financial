	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="resources/img/logo20.png" /> <span>大T的财管</span></a>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="index.html"><i class="icon-home"></i><span class="hidden-tablet"> 菜单</span></a></li>
					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								...
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="resources/img/qrcode136.png" />
							</div>
