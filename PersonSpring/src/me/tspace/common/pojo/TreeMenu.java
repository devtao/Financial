...
public class TreeMenu {
	...
	public TreeMenu(List<BaseModules> list , BaseUsers users,MessageSource messageSource,Locale locale) {
		this.list = list;
	...
	private Tree getNodeJson(List<BaseModules> list, BaseModules node) {
		...
		tree.setText("zh".equals(locale.getLanguage())?node.getModuleName():node.getEnModuleName());
	...
	private  String returnMsg(String str){
