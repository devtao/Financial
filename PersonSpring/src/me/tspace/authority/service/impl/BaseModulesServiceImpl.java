...
import me.tspace.authority.dao.BaseModulesMapper;
...
import me.tspace.common.pojo.TreeMenu;
...
public class BaseModulesServiceImpl implements BaseModulesService {
	...
	@Override
	public Tree selectAllModules(Criteria example,BaseUsers user,MessageSource messageSource,Locale locale) {
		...
		TreeMenu menu = new TreeMenu(list,user, messageSource, locale);
		return menu.getTreeJson();
	}

	@Override
	public Tree selectModulesByUser(BaseUsers baseUser,MessageSource messageSource,Locale locale) {
		...
		TreeMenu menu = new TreeMenu(list,baseUser,messageSource,locale);
		return menu.getTreeJson();
	}
